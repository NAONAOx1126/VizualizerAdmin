 ...
 * @author Naohisa Minagawa <info@vizualizer.jp>
 */
class VizualizerAdmin_Module_Trade_Pdf_Bill extends Vizualizer_Plugin_Module_Pdf
{
    ...
    function execute($params)
    {
        ...
        foreach($tradeIds as $tradeId){
            ...
            // 作成日を描画
            $this->text(450, 68, 9, "ご請求日：".date("Y年m月d日", strtotime($trade->billing_date)), true);
            $this->text(450, 80, 9, "ご入金期限：".date("Y年m月d日", strtotime($trade->payment_date)), true);
            ...
            // 合計金額を描画
            $this->text(35, 230, 20, "ご請求金額： ￥".number_format($trade->total)."-", true);
