 ...
 * @author Naohisa Minagawa <info@vizualizer.jp>
 */
class VizualizerAdmin_Module_Trade_Pdf_Deliver extends Vizualizer_Plugin_Module_Pdf
{
    ...
    function execute($params)
    {
        ...
        foreach($tradeIds as $tradeId){
            ...
            // 作成日を描画
            $this->text(450, 68, 9, "納品日：".date("Y年m月d日", strtotime($trade->delivered_date)), true);
